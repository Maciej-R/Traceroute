...
int main (void)
{
  ...
  // }
	...
	while (1)
	{
      ...
      // int rcv_icmp_pkt_sz = hdr_sz + 32 + sizeof(iphdr);
      ...
      // struct timespec start, end;
	    // bzero(&end, sizeof(end));
			...
			// 	int r_code = recvfrom(s, rcv_icmp_pkt, rcv_icmp_pkt_sz, 0, (struct sockaddr*) &received, &len);
			// 	if (r_code < 0){
			...
			// 			sockaddr_in* dst = (sockaddr_in*) &sin;
